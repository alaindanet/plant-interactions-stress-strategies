...
# opts <- knit$set(progress = TRUE,
#        	verbose = TRUE,
# 	base.dir="../ressources/figures/")
```
...
When the leaves were taken from the tubes, we first rehydrated them with deionized water. Following this, we weighted them, scanned, measured them, put them in an envelope, and finally put them in the drier. 
