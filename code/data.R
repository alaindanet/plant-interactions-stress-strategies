...
setwd("/home/alain/Documents/thesis/alicante/thesis_chap2_alicante/data/")


load.plant <- function (data="data_january_plant.csv") {
...
load.traits <- function (data="data_mars_traits.csv") {
