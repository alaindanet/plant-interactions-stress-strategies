...
tra <- data[data$e1<=2 & data$e2<=2 & data$e3<=2,]
...
We recorded the vegetative height and the basal diameter of the plants. Let's see the summary results. The vegetation height was measured as a light competitive trait. It means that we measured the plants without moving them.
