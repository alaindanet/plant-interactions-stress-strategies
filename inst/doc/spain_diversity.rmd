...
# Solve thanks to the Hungarian algorithm
#https://stackoverflow.com/questions/13961493/finding-the-best-matching-pairwise-points-from-2-vectors
pair_find2 <- function(x){
    ...
    # Compute the distance between open et patch algorythm
...
holes_pairs2 <- holes_pairs %>%
    mutate(pair = map(data, pair_find2)) %>%
    unnest(pair) %>%
    mutate(
