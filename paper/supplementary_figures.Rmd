...
Highest Posterior Density method. Note that there is few differences between the
model without (community level) and with (species level) species specific
effects of treaments." %>% str_replace_all("\\s+", " ")
