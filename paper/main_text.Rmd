...
beneficiary communities in their understorey, could mitigate such climate-induced
...
arise from trait-based ecology and ecosystem functioning research: selection
effects (i.e. competitive hierarchy), complementarity effects (i.e. niche
differentiation and facilitation) and trait profile changes (plasticity). There
are independent pieces of evidence for all three of these, which we review below
...
selection effects, provides key predictions about the outcome of
...
phenotypic plasticity or evolution. The response to variation in environmental
conditions can be assessed using leaf functional traits. In harsh environments,
previous research identified that beneficiary species located beneath and within
...
facilitative effects are lower under lower water stress. Our experiment allows
us to gather data about the relative importance of complementarity, selection
effects and trait profiles in shaping patterns of facilitation. To gather this
evidence we performed a fully factorial experiment crossing beneficiary species
diversity (three species in monoculture and three species communities), presence
and absence of nurse species (nurse patch vs. open) and presence and absence of
watering (reduced drought vs drought). Specifically, with this design, we ask
the following 4 questions. 1) How does species richness of beneficiary
...
[@callaway_competition_1996]. It was reported to be partially phytotoxic, producing
...
the fitted versus the observed values (Fig. S4) and visually inspected the
aggrement between predicted and observed differences between treatments (Fig.
S5, S7, S8). The conditional $R^2$ of the models were of 0.37, 0.09, 0.66 for
...
lt_cap <- paste0("Effects of the nurse, watering and beneficiary community
  ...
  the predictions of the model are displayed in Fig. S6c and S7. (b) Species
...
vs 28.9 [27.6, 30.1] in June, i.e. -11%, Fig. S1), and a Photosynthetic Active
...
of those beneficiary communities? 2) How do nurse plants alter the functional
traits of beneficiary communities? 3) How do nurse plants affect complementarity
and competitive hierarchy in beneficiary communities? 4) How do nurse plants and
water stress interact in driving the response of the beneficiary communities?
Overall, we found that nurse facilitation only occurred in case of
...
in diverse beneficiary communities compared to monoculture) and on the traits of
beneficiaries. However, the nurse treatment differed from the watering one in
its effect on competitive hierarchy, as nurses facilitated more the most
maladapted species (i.e. negative selection effects) regardless of the water
...
effect of the
nurse. Such shading can induce a compensation for the limited amount of
radiation received and is a common adaptation in understorey plants [@pons_ecophysiological_1977;
@ackerly_leaf_2002; @liu_does_2016; @yang_effects_2019]. We, however, did not
find that watering affected the SLA of beneficiary communities in open sites,
but did lead to lower LDMC. This result suggests that the response of leaf
traits to the decrease in water stress in open sites did not imply changes in
leaf area, possibly because of the higher evapotranspiration in open sites,
which might constrain leaf area to small sizes despite lower water stress.
Overall, our results are consistent with previous results showing that a
decrease in water stress results in plant plastic responses toward higher SLA
and lower LDMC [@galmes_modulation_2005; @zhang_mechanisms_2015; @jung_intraspecific_2014, but
see @majekova_weak_2021]. However, a direct measurement of plant physiological
activity would be needed to draw a stronger conclusion on the links among nurse
presence, water stress, and plant strategy. We did not find an effect of species
richness of beneficiary communities on average LDMC and SLA. This may be because
functional traits are expected to respond to variations in species richness in
terms of trait variance and overlap [@violle_return_2012;
...
diversity net effects associated with competitive hierarchy were very low
compared to complementarity effects, a result that matches previous findings in
grasslands [@loreau_partitioning_2001; @fargione_selection_2007]. This dominance of
...
effects in non-watered sites. This highlights, in a similar way to functional
traits, the commonality in the effects of watering and nursing.


Although lower than complementarity effects in magnitude, we found that the
effects of nurse plants on selection effects differed from the ones of watering,
such as nurse plants facilitated more the most drought-sensitive species
(negative selection effects) while watering enhanced competitive hierarchy
(positive selection effects). Lowering water stress through watering led to
positive selection effects in open sites (compared to quasi neutral selection
effects without watering), i.e. that species that had higher biomass in
monoculture also had the higher increase in biomass in species-diverse
beneficiary communities. This result indicates that the direct alleviation of
water stress by watering results in the competitive dominance of species that
already perform best in monoculture while drier, more stressful conditions
suppress this competitive dominance. It agrees with previous findings showing
that even small changes in environmental conditions can result in a shift in the
competitive hierarchy among species [@morcillo_functional_2019;
@alexander_when_2016; @van_dyke_small_2022]. The negative selection effects found in
...
differentiation and facilitation among beneficiary species. But, if nurses
...
the survival of plants in their understorey, but also amplify the beneficial
