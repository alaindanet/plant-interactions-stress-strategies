...
long and severe drought (see Methods, Fig. S1) and designed to test how
facilitative effects provided by nurse species in drylands differed for
...
long-term average) and experienced a mean annual temperature of 20°C, almost 2
°C above the long-term average (Meteorological State Agency, AEMET).
The Standardised Precipitation Evapotranspiration Index (SPEI), a proxy for
water balance, was during the experiment 1.5 standard deviations lower than the
average over the 1950-2023 period in the region (Fig. S1). Soils
...
conditions. We watered the planting microsites 8 times during 2016 around 6pm to
avoid the strongest
...
community biomass, driven solely by positive complementarity effects. Overall,
diversity net effects associated with competitive hierarchy (measured by
selection effects) were very low compared to complementarity effects, a result
that matches previous findings in grasslands [@loreau_partitioning_2001;
@fargione_selection_2007]. This dominance of complementary effects rather than
competitive hierarchy suggests that the processes linked to niche
differentiation and facilitation play a more important role than the ones linked
to competitive dominance. Watering increased complementarity effects in open
sites and nursing increased complementarity effects in non-watered sites. This
highlights, similar to functional traits, the commonality in the
effects of watering and nursing.
